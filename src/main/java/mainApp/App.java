...
public class App 
{
    public static void main( String[] args )
    {
        ...
        network.setNetworkLayer(0, new NetworkLayer(4,network.getLayer(0).getLayerSize()));
        network.setNetworkLayer(0, new NetworkLayer(1,network.getLayer(1).getLayerSize()));
    }
}
